extends RefCounted
## PATOGEN MALL V5 — canonical geometry shared by visuals and collision.
## Do not duplicate store positions in other scripts.
...
const KIOSKS := [Vector2(980,1100), Vector2(2220,1100), Vector2(1210,1450), Vector2(1990,1450)]
